...
public enum ErrorCode implements ErrorCodeSpec {
    ...
    CARGO_ACCEPTANCE_NOT_FOUND(409, "수락되지 않은 화물은 취소할 수 없습니다."),
    CARGO_ACCEPTANCE_ACCESS_DENIED(403, "본인이 수락한 화물만 취소할 수 있습니다."),
    CARGO_ACCEPTANCE_ALREADY_COMPLETED(409, "완료된 화물은 수락 취소할 수 없습니다."),
    CARGO_ACCEPTANCE_NOT_CANCELABLE(409, "배차 중인 화물만 수락 취소할 수 있습니다."),
    CARGO_NOT_ASSIGNED(409, "수락되지 않은 화물은 완료할 수 없습니다."),
    CARGO_ASSIGNMENT_ACCESS_DENIED(403, "본인이 수락한 화물만 완료할 수 있습니다."),
    CARGO_ALREADY_COMPLETED(409, "이미 완료된 화물입니다."),
    CARGO_NOT_COMPLETABLE(409, "배차 중인 화물만 완료할 수 있습니다."),
