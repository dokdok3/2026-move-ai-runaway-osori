...
CREATE TABLE driver (
    ...
    preferred_destination    geography(Point, 4326),
    available_from           TIMESTAMP NOT NULL DEFAULT '2026-08-01 00:00:00',
    available_until          TIMESTAMP NOT NULL DEFAULT '2026-12-31 23:59:59',
    pickup_radius_m          INTEGER NOT NULL DEFAULT 50000,
    destination_radius_m     INTEGER NOT NULL DEFAULT 100000,
    preference_text          TEXT,
    created_at               TIMESTAMP NOT NULL DEFAULT now(),
    updated_at               TIMESTAMP NOT NULL DEFAULT now(),
    CONSTRAINT driver_capacity_ton_check
        CHECK (capacity_ton IS NULL OR capacity_ton > 0),
    CONSTRAINT driver_pickup_radius_m_check
        CHECK (pickup_radius_m BETWEEN 1000 AND 200000),
    CONSTRAINT driver_destination_radius_m_check
        CHECK (destination_radius_m BETWEEN 1000 AND 300000),
    CONSTRAINT driver_available_window_check
